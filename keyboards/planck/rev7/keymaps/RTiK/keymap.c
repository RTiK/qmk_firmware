 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | <  > | Alt  | GUI  |Lower |    Space    |Raise | Alt  | PgDn | PgUp |Enter |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, CH_LABK, KC_LALT, KC_LGUI, LOWER,   KC_RSFT, KC_SPC,  RAISE,   KC_RALT, KC_PGDN, KC_PGUP, KC_ENT
),
...
[_RAISE] = LAYOUT_planck_grid(
    KC_TILD, CH_1,    CH_2,    CH_3,    CH_4,    CH_5,    CH_6,    CH_7,    CH_8,    CH_9,    CH_0,    KC_BSPC,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_UP,   KC_END,  CH_DLR,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT,CH_QUOT,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_RALT, _______, _______, CH_CIRC
),
