 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|   Y  |   X  |   C  |   V  |   B  |   N  |   M  | ,  ; | .  : | -  _ |Backsp|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Brite| Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Alt  | PgDn | PgUp |Enter |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LSFT, CH_Y,    CH_X,    CH_C,    CH_V,    CH_B,    CH_N,    CH_M,    CH_COMM, CH_DOT,  CH_MINS, KC_BSPC,
    BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_RSFT, KC_SPC,  RAISE,   KC_RALT, KC_PGDN, KC_PGUP, KC_ENT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_BSPC, KC_F4,   KC_F5,   KC_F6,   _______, _______, _______, _______,    CH_4,    CH_5,   CH_6,   KC_HOME,
    _______, KC_F7,   KC_F8,   KC_F9,   _______, _______, _______, _______,    CH_7,    CH_8,   CH_9,   KC_DEL,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_UP,   CH_LABK,
