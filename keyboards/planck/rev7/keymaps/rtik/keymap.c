 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|   Y  |   X  |   C  |   V  |   B  |   N  |   M  | ,  ; | .  : | -  _ |RSH/EN|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | <  > | Alt  | GUI  |Lower |    Space    |Raise |ALT/Lt| Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LSFT, CH_Y,    CH_X,    CH_C,    CH_V,    CH_B,    CH_N,    CH_M,    CH_COMM, CH_DOT,  CH_MINS, RSFT_T(KC_ENT),
    KC_LCTL, CH_LABK, KC_LALT, KC_LGUI, LOWER,   KC_RSFT, KC_SPC,  RAISE,   RALT_T(KC_LEFT), KC_DOWN, KC_UP,   KC_RGHT
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |ALT/Hm|Pg Up |Pg Dn |  End |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_planck_grid(
    CH_LABK, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR,    KC_ASTR,    KC_LPRN, KC_RPRN, CH_DIAE,
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS,    KC_PLUS,    KC_LCBR, KC_RCBR,  CH_DLR,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_HOME, KC_END,  _______,
    _______, _______, _______, _______, _______, _______, _______, _______,    RALT_T(KC_HOME), KC_PGDN, KC_PGUP,  KC_END
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, CH_QUOT, CH_CIRC, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, RALT_T(KC_MNXT), KC_VOLD, KC_VOLU, KC_MPLY
),
